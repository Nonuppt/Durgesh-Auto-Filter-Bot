...
# ============================
COVERX = is_enabled((environ.get('COVERX', 'False')), False)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Durgesh:Nonu0000@cluster0.xiraxdc.mongodb.net/mydb?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "mydb") # Database name (default: cluster)
...
MOVIE_UPDATE_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('MOVIE_UPDATE_CHANNEL', '-1002414133579 -1002481569627').split()]  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002714001584')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002714001584')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/Pixell_Pulse/16")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Pixell_Pulse/26")   # Second tutorial link for verification
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "950d32f88d907335e5a52ccc1a87e52106520a88")  # Shortener API key for second website
