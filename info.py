...
MOVIE_UPDATE_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in re.split(r'[,\s]+', environ.get('MOVIE_UPDATE_CHANNEL', '-1002414133579 -1002481569627')) if ch]  # Notification of sent to your channel
