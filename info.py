...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Pixell_Pulse/16")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Pixell_Pulse/16")   # Third tutorial link for verification
...
if ON_HEROKU:
    ...
    FQDN = environ.get('RENDER_EXTERNAL_HOSTNAME', BIND_ADRESS)
else:
...
if ON_HEROKU or ON_RENDER or NO_PORT:
    URL = f"{SCHEME}://{FQDN}/"
else:
